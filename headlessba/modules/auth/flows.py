...
from headlessba.core.client import BAReplayClient
...
from headlessba.modules.auth.nexon_web import DEFAULT_LATEST_TOKENS, WebLoginTokens, load_latest_tokens, run_playwright_web_login
from headlessba.utils.proxy import apply_proxy_env, normalize_proxy_url
from headlessba.modules.runtime.region_config import profile_for
from headlessba.modules.runtime.runtime_config import RuntimeConnectionInfo, discover_client_version, discover_connection_info
from headlessba.modules.auth.toysdk_android import AndroidDeviceProfile, AndroidToyConfig, AndroidToySdkClient, android_session_to_dict
...
def resolve_toy_login(options: IntegratedLoginOptions, web_token: str, output_dir: Path) -> ToySdkLoginResult:
    ...
    if options.pc_native_login:
        from headlessba.modules.auth.nexon_login import toy_callback_to_dict, toy_ticket_to_dict
        from headlessba.modules.auth.toysdk_native import DEFAULT_NATIVE_DLL, ToySdkNative
