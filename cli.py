...
from config.paths import DEFAULT_BLUEARCHIVE_CORE_PACKET_DIR, DEFAULT_TOOLS_DIR
...
from modules.auth.nexon_web import DEFAULT_LATEST_TOKENS, load_latest_tokens, run_playwright_url_tokens, run_playwright_web_login
from modules.auth.nexon_web import start_playwright_url, stop_process
from utils.proxy import apply_proxy_env, normalize_proxy_url, redact_proxy_url
from modules.runtime.region_config import build_login_url, list_profiles, profile_for
...
def resolve_toy_login(args: argparse.Namespace, web_token: str) -> ToySdkLoginResult:
    ...
    from modules.auth.toysdk_native import ToySdkNative
